...
class Register extends CI_Controller {
    function index() {
        ...
        $this->form_validation->set_rules('password_member', 'email', 'required');
        ...
        $this->form_validation->set_message('is_unique', '%s yang sama sudha digunakan');
        if ($this->form_validation->run() == TRUE) {
            ...
            $this->session->set_flashdata('pesan_sukses', 'Registrasi Berhasil, Sialahkan Login!');
            redirect('/', 'refresh');
